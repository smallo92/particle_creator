config = {
	...
	particles = {
		{dict = 'core', name = 'ent_amb_smoke_chicken', scale = 1.0, coords = vec(-2020.85, -1038.95, 1.00)},
		{dict = 'core', name = 'ent_amb_smoke_foundry', scale = 1.0, coords = vec(-2069.53, -1023.06, 10.00)}
	}
